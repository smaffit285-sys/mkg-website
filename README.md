# Miami Knife Guy Public Website

This repository contains the public Miami Knife Guy website for miamiknifeguy.com.
...
Do not use `git add .`. Stage only the specific named files required for the current change.

Preview the site locally before pushing any branch, and get visual approval before merging or deploying.
